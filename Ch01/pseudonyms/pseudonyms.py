"""Generate funny names (a la TV show Psych) by randomly combining names fomr 2 separate lists"""
import sys
import random

def main():
    """ Chooose names at random from 2 tuples of names and print to screen """
