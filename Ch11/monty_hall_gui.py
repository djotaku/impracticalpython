...
class Game(tk.Frame):
    ...
    def create_widgets(self):
        ...
        # create label to hold images of doors
        ...
        # craete widgets for changing door chioce
        ...
        self.unchanged_wins_text = tk.Text(self.parent, width=20,
                                           heigh=1, wrap=tk.WORD,
        ...
        self.unchanged_wins_text.grid(row=1, column=5, columnspan=5)
    ...
    def show_final(self):
        ...
        self.unchanged_wins_text.delete(1.0, 'end')
        self.unchanged_wins_text.insert(1.0, f"Unchanged wins = {self.first_choice_wins:d}")
...
root.geometry('1280x820')  # images are 1280x720
game = Game(root)
root.mainloop()
